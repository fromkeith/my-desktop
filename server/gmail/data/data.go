...
func (g AccountTag) ToDocumentId() string {
	return ToDocumentId(g.AccountId, strings.ToLower(g.Tag))
}
...
func (g AccountCategory) ToDocumentId() string {
	return ToDocumentId(g.AccountId, strings.ToLower(g.Category))
}
...
func (g MessageTag) ToDocumentId() string {
	return ToDocumentId(g.AccountId, ToDocumentId(strings.ToLower(g.Tag), g.MessageId))
}
...
func (g MessageCategory) ToDocumentId() string {
	return ToDocumentId(g.AccountId, ToDocumentId(strings.ToLower(g.Category), g.MessageId))
}
